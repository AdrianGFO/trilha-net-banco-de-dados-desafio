...
-- Inicio do desafio de Consultas

--Desafio 1: Buscar o nome e ano dos filmes.
SELECT Nome, Ano FROM Filmes

--Desafio 2: Buscar o nome e ano dos filmes, ordenados por ordem crescente 
--pelo ano.
SELECT Nome, Ano, Duracao FROM Filmes
ORDER BY Ano

--Desafio 3: Buscar pelo filme de volta para o futuro, trazendo o nome, 
--ano e a duração
SELECT Nome, Ano, Duracao FROM Filmes
